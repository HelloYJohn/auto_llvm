...
Module* makeLLVMModule(Module* mod, FuncType& funcType) {
    ...
    // Function: invoke (func_invoke)
    {
        ...
        //Value* ptr_call =  getPFDSType(label_entry, ptr_paraList);
        ...
        ptr_call_params.push_back(const_int64_0);
        ...
        ptr_call4_params.push_back(const_int64_1);
        CallInst* ptr_call4 = CallInst::Create(func_vectorPFDSType_at, ptr_call4_params, "call4", label_entry);
        ...
        ptr_pfdsValue5_indices.push_back(const_int32_0);
        ptr_pfdsValue5_indices.push_back(const_int32_1);
        ...
        CastInst* ptr_42 = new BitCastInst(ptr_41, PointerTy_int32, "", label_entry);
        ...
        int32_call6_params.push_back(int32_43);
        ...
        CastInst* ptr_50 = new BitCastInst(ptr_49, PointerTy_int32, "", label_entry);
